...
router.get("/changepassword/:id", authMiddlerware.isAuthenticated, authController.changePassword);
...
router.post('/changepassword/:id', authvalidation.validationChangepassword, authController.changePasswordPage);
